...
public interface MNBArfolyamServiceSoap {
    ...
    @RequestWrapper(localName = "GetCurrencies", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetCurrenciesRequestBody")
    @ResponseWrapper(localName = "GetCurrenciesResponse", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetCurrenciesResponseBody")
    ...
    @RequestWrapper(localName = "GetCurrencyUnits", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetCurrencyUnitsRequestBody")
    @ResponseWrapper(localName = "GetCurrencyUnitsResponse", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetCurrencyUnitsResponseBody")
    ...
    @RequestWrapper(localName = "GetCurrentExchangeRates", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetCurrentExchangeRatesRequestBody")
    @ResponseWrapper(localName = "GetCurrentExchangeRatesResponse", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetCurrentExchangeRatesResponseBody")
    ...
    @RequestWrapper(localName = "GetDateInterval", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetDateIntervalRequestBody")
    @ResponseWrapper(localName = "GetDateIntervalResponse", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetDateIntervalResponseBody")
    ...
    @RequestWrapper(localName = "GetExchangeRates", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetExchangeRatesRequestBody")
    @ResponseWrapper(localName = "GetExchangeRatesResponse", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetExchangeRatesResponseBody")
    ...
    @RequestWrapper(localName = "GetInfo", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetInfoRequestBody")
    @ResponseWrapper(localName = "GetInfoResponse", targetNamespace = "http://www.mnb.hu/webservices/", className = "com.beadando.forexapp.mnbsoap.GetInfoResponseBody")
